...
impl StrategyParams {
    pub fn new(strategy_type: &str) -> Self {
        ...
        match strategy_type {
            ...
            "mc_trend_v2" => {
                ...
                params.insert("auto_timeframe".into(), 5.0);
                params.insert("auto_position_count".into(), 5.0);
                params.insert("capital_usage_pct".into(), 50.0); // Only 50% for trend riding
                params.insert("target_mult".into(), 2.0);
                params.insert("min_safety".into(), 50.0);
                params.insert("min_volume_5m".into(), 5000.0);
                params.insert("max_mcap".into(), 500000.0);
                params.insert("min_buy_sell_ratio".into(), 1.5);
                params.insert("hard_stop_pct".into(), 50.0); // -50% hard stop
                params.insert("time_limit_mins".into(), 120.0); // 2 hour max
            }
            "mc_copy_v2" => {
                params.insert("auto_leverage".into(), 1.0);
                params.insert("auto_timeframe".into(), 5.0);
                params.insert("auto_position_count".into(), 5.0);
                params.insert("capital_usage_pct".into(), 50.0); // 50% for copy trading
                params.insert("min_safety".into(), 40.0);
                params.insert("min_whale_wr".into(), 35.0);
                params.insert("max_entry_delay".into(), 3.0); // max 3x from whale's entry
                params.insert("hard_stop_pct".into(), 50.0);
                params.insert("time_limit_mins".into(), 30.0);
            }
            _ => {
                params.insert("auto_leverage".into(), 5.0);
                params.insert("auto_timeframe".into(), 15.0);
    ...
    pub fn mutable_params(&self) -> Vec<String> {
        let mut params = match self.strategy_type.as_str() {
            ...
            "mc_trend_v2" => vec!["target_mult".into(), "min_safety".into(), "min_volume_5m".into(), "max_mcap".into(), "min_buy_sell_ratio".into(), "hard_stop_pct".into(), "time_limit_mins".into()],
            "mc_copy_v2" => vec!["min_safety".into(), "min_whale_wr".into(), "max_entry_delay".into(), "hard_stop_pct".into(), "time_limit_mins".into()],
...
pub fn initial_strategies() -> Vec<(String, StrategyParams)> {
    vec![
        ...
        // ═══ Meme Coins V2 — Trend Riding (20) — prefix MC-TR- ═══
        // LEARNED FROM EVOLUTION: winning explorers use tight stops (15-20%), quick TP (1.1-1.3x),
        // many positions (12-17), and leverage (4-6x). Losers used 50% stops, 2-5x targets, 5 positions.
        // Key insight: meme coins are about FAST SMALL wins, not moonshots. Cut losses fast, take profits quick.
        ("MC-TR-vol-surge-5x".into(),       StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 5000.0).with_param("target_mult", 1.15).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 30.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-vol-surge-10x".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 10000.0).with_param("target_mult", 1.20).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-fresh-grad-1h".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.12).with_param("min_safety", 50.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 30.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-fresh-grad-5m".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 1000.0).with_param("target_mult", 1.25).with_param("min_safety", 40.0).with_param("max_mcap", 1000000.0).with_param("hard_stop_pct", 20.0).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-holder-rocket".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 3000.0).with_param("target_mult", 1.20).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-holder-steady".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.10).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-narrative-hot".into(),      StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 3000.0).with_param("target_mult", 1.18).with_param("min_safety", 50.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-narrative-original".into(), StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.30).with_param("min_safety", 50.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 20.0).with_param("time_limit_mins", 30.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 6.0)),
        ("MC-TR-buy-pressure".into(),       StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 5000.0).with_param("target_mult", 1.15).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-buy-moderate".into(),       StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 1000.0).with_param("target_mult", 1.10).with_param("min_safety", 40.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 10.0).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-mcap-micro".into(),         StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 1000.0).with_param("target_mult", 1.30).with_param("min_safety", 40.0).with_param("max_mcap", 100000.0).with_param("hard_stop_pct", 20.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 6.0)),
        ("MC-TR-mcap-small".into(),         StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.20).with_param("min_safety", 50.0).with_param("max_mcap", 500000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-mcap-mid".into(),           StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 3000.0).with_param("target_mult", 1.12).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-dip-recovery".into(),       StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.15).with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 13.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-momentum-5m".into(),        StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 3000.0).with_param("target_mult", 1.10).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-momentum-15m".into(),       StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.15).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-high-safety".into(),        StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 3000.0).with_param("target_mult", 1.12).with_param("min_safety", 80.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC-TR-balanced".into(),           StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 2000.0).with_param("target_mult", 1.15).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC-TR-aggressive".into(),         StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 500.0).with_param("target_mult", 1.25).with_param("min_safety", 30.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 20.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 70.0).with_param("auto_leverage", 6.0)),
        ("MC-TR-explorer".into(),           StrategyParams::new("mc_trend_v2").with_param("min_volume_5m", 1000.0).with_param("target_mult", 1.20).with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 5.0)),

        // ═══ Meme Coins V2 — Copy Trading (20) — prefix MC-CT- ═══
        // Same lesson: tight stops, quick TP, many positions, some leverage
        ("MC-CT-top-pnl-10".into(),     StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-top-pnl-5".into(),      StrategyParams::new("mc_copy_v2").with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.12)),
        ("MC-CT-high-wr".into(),        StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.15)),
        ("MC-CT-high-multiplier".into(), StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 13.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 6.0).with_param("target_mult", 1.25)),
        ("MC-CT-early-buyer".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-whale-50k".into(),      StrategyParams::new("mc_copy_v2").with_param("min_safety", 50.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.10)),
        ("MC-CT-whale-10k".into(),      StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-consensus-2".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-consensus-3".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.12)),
        ("MC-CT-fast-follow".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("time_limit_mins", 10.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.08)),
        ("MC-CT-delayed-safe".into(),   StrategyParams::new("mc_copy_v2").with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.15)),
        ("MC-CT-sell-mirror".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-fresh-only".into(),     StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 10.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.20)),
        ("MC-CT-volume-confirm".into(), StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-ai-verified".into(),    StrategyParams::new("mc_copy_v2").with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0).with_param("target_mult", 1.12)),
        ("MC-CT-conservative".into(),   StrategyParams::new("mc_copy_v2").with_param("min_safety", 60.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 3.0).with_param("target_mult", 1.08)),
        ("MC-CT-balanced".into(),       StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-aggressive".into(),     StrategyParams::new("mc_copy_v2").with_param("min_safety", 30.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 20.0).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 70.0).with_param("auto_leverage", 6.0).with_param("target_mult", 1.25)),
        ("MC-CT-contrarian".into(),     StrategyParams::new("mc_copy_v2").with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.15)),
        ("MC-CT-explorer".into(),       StrategyParams::new("mc_copy_v2").with_param("min_safety", 35.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 5.0).with_param("target_mult", 1.18)),

        // ═══ Meme Coins V2 — AI Trend Riding (20) — prefix MC2-TR-ai- ═══
        // Claude AI score threshold gates entry; regime_filter bitmask: 1=pump,2=distribution,4=dead_cat,8=organic
        ("MC2-TR-ai-sniper".into(),       StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 80.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-TR-ai-aggressive".into(),   StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 40.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 20.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 6.0)),
        ("MC2-TR-ai-conservative".into(), StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 85.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 3.0)),
        ...
        ("MC2-TR-ai-pump-rider".into(),   StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 50.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-TR-ai-organic".into(),      StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-TR-ai-high-vol".into(),     StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 5000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-TR-ai-micro-cap".into(),    StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 50.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 100000.0).with_param("hard_stop_pct", 20.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 6.0)),
        ("MC2-TR-ai-mid-cap".into(),      StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ...
        ("MC2-TR-ai-tight-sl".into(),     StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-TR-ai-wide-tp".into(),      StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("target_mult", 1.30).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-TR-ai-fast-exit".into(),    StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 10.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC2-TR-ai-patient".into(),      StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 75.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 45.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 4.0)),
        ("MC2-TR-ai-diversified".into(),  StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 50.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 20.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-TR-ai-concentrated".into(), StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 80.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 8.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 6.0)),
        ("MC2-TR-ai-momentum".into(),     StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 5000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-TR-ai-safe".into(),         StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 80.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 3.0)),
        ("MC2-TR-ai-explorer".into(),     StrategyParams::new("mc2_ai_trend").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),

        // ═══ Meme Coins V2 — AI Copy Trading (20) — prefix MC2-CT-ai- ═══
        // Claude AI score threshold gates copy entries; regime_filter bitmask same as above
        ("MC2-CT-ai-top-pnl".into(),      StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-selective".into(),    StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 75.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-fast".into(),         StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("target_mult", 1.10).with_param("time_limit_mins", 10.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-override".into(),     StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 0.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-whale".into(),        StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 65.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.12).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-consensus".into(),    StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.12).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-early".into(),        StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 50.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 2000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.20).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-balanced".into(),     StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 65.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-safe".into(),         StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 75.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 60.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 10.0).with_param("target_mult", 1.10).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 3.0)),
        ("MC2-CT-ai-aggressive".into(),   StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 40.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 10000000.0).with_param("hard_stop_pct", 20.0).with_param("target_mult", 1.20).with_param("time_limit_mins", 15.0).with_param("auto_position_count", 17.0).with_param("capital_usage_pct", 70.0).with_param("auto_leverage", 6.0)),
        ("MC2-CT-ai-micro".into(),        StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 500000.0).with_param("hard_stop_pct", 18.0).with_param("target_mult", 1.20).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-patient".into(),      StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 8.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 45.0).with_param("auto_position_count", 12.0).with_param("capital_usage_pct", 55.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-volume".into(),       StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 5000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-contrarian".into(),   StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 65.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 4.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-trust-test".into(),   StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 65.0).with_param("trust_ai_exits", 0.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-tight".into(),        StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 70.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 9.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 8.0).with_param("target_mult", 1.10).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-wide".into(),         StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 22.0).with_param("target_mult", 1.30).with_param("time_limit_mins", 25.0).with_param("auto_position_count", 14.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-diversified".into(),  StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 50.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 15.0).with_param("target_mult", 1.12).with_param("time_limit_mins", 22.0).with_param("auto_position_count", 18.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 4.0)),
        ("MC2-CT-ai-explorer".into(),     StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 55.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 15.0).with_param("min_volume_5m", 2000.0).with_param("min_safety", 40.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 18.0).with_param("target_mult", 1.18).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 65.0).with_param("auto_leverage", 5.0)),
        ("MC2-CT-ai-momentum".into(),     StrategyParams::new("mc2_ai_copy").with_param("min_ai_score", 60.0).with_param("trust_ai_exits", 1.0).with_param("regime_filter", 1.0).with_param("min_volume_5m", 5000.0).with_param("min_safety", 50.0).with_param("max_mcap", 5000000.0).with_param("hard_stop_pct", 12.0).with_param("target_mult", 1.15).with_param("time_limit_mins", 20.0).with_param("auto_position_count", 15.0).with_param("capital_usage_pct", 60.0).with_param("auto_leverage", 5.0)),
    ]
}
